...
#include "mvf-core.h"            // MVF-CORE added (needed for TRIG, DIAD, ...)
...
public:
    CMainParams() {
        ...
        // MFV-Core begin: added deployment of BIP141/143/147 (MVHF-CORE-DES-TRIG-2)
        ...
        // MVF-Core begin replace seeds (MVHF-CORE-DES-NSEP-?)
        vSeeds.push_back(CDNSSeedData("bitcoinforks.org", "seed.bitcoinforks.org")); // BTCFork
        // MVF-Core end
...
public:
    CTestNetParams() {
        ...
        vSeeds.clear();
        // MVF-Core begin replace seeds (MVHF-CORE-DES-NSEP-?)
        vSeeds.push_back(CDNSSeedData("bitcoinforks.org", "testnet-seed.bitcoinforks.org")); // BTCFork
        // MVF-Core end
